<body>
    ...
    <section class="about-section" id="about">
        <div class="container">
            <div class="row">
                <div class="col introduction" data-aos="fade-up">
                    ...
                    <p class="description">I am currently studying ICT & Software at <a href="https://fontys.edu/Bachelors-masters/Bachelors/Information-Communication-Technology-Eindhoven.htm" target="_blank" rel="noreferrer noopener">Fontys University of Applied Sciences</a> in Eindhoven. I am a 1st year student here. Before I came to Fontys I've studied Application- and Mediadesign at <a href="https://vistacollege.nl/opleiding/applicatie-en-media-ontwikkelaar" target="_blank" rel="noreferrer noopener">Vista College.</a> This was a 3 year long eduction in Sittard and Maastricht. Here I have learned to program in numerous different languages. PHP and C# were the main languages i've come in contact with then. But I also know my way around with HTML, CSS, JavaScript (Although still learning) and SQL.</p>
                </div>
                <div class="col intro-picture" data-aos="fade-up">
                    <div class="picture">
                        <img src="assets/images/SelfieAchtergrondWeg.png" alt="Selfie from me!" width="500px" class="img">
